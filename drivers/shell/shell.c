...
Command commands[] = {
    {"help",       help_command,      "Display information on commands"},
    {"clear",      clear_command,     "Clear the tty"},
    {"echo",       echo_command,      "Display a one-line string"},
    {"cpuinfo",    cpuinfo_command,   "Display CPU information"},
    {"reboot",     reboot_command,    "Restart the machine"},
    {"shutdown",   shutdown_command,  "Shutdown the machine"},
